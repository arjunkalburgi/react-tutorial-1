...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(37);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_Subscription__ = __webpack_require__(8);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_connectAdvanced__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_Subscription__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_storeShape__ = __webpack_require__(9);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_connectAdvanced__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(32);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__wrapMapToProps__ = __webpack_require__(7);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__wrapMapToProps__ = __webpack_require__(7);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(33);
...
function numberReducer(state, action) {
    if (state === void 0) { state = { number: 0 }; }
    // return new state
    // action = { type: "ADD" }
    if (action.type == ADD) {
        return {
...
var store = redux_1.createStore(numberReducer, window.__REDUX_DEVTOOLS_EXTENSION__ && window.__REDUX_DEVTOOLS_EXTENSION__());
var FizzBuzzDisplay = (function (_super) {
    __extends(FizzBuzzDisplay, _super);
    function FizzBuzzDisplay() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FizzBuzzDisplay.prototype.render = function () {
    ...
    return FizzBuzzDisplay;
}(react_1.Component));
var FizzBuzz = (function (_super) {
    __extends(FizzBuzz, _super);
    function FizzBuzz(props) {
        return _super.call(this, props) || this;
    }
    FizzBuzz.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(ConnectedFizzBuzzDisplay, null),
            React.createElement("button", { onClick: this.props.minus }, "-"),
            React.createElement("button", { onClick: this.props.plus }, "+")));
    };
    return FizzBuzz;
}(react_1.Component));
var BuzzFizzDisplay = (function (_super) {
    __extends(BuzzFizzDisplay, _super);
    function BuzzFizzDisplay() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BuzzFizzDisplay.prototype.render = function () {
        if ((this.props.number) % 3 == 0) {
            return React.createElement("div", null, "\"Buzz\"");
        }
        else if ((this.props.number) % 5 == 0) {
    ...
    return BuzzFizzDisplay;
}(react_1.Component));
var BuzzFizz = (function (_super) {
    __extends(BuzzFizz, _super);
    function BuzzFizz(props) {
        return _super.call(this, props) || this;
    }
    BuzzFizz.prototype.render = function () {
        return (React.createElement("div", null,
            React.createElement(ConnectedBuzzFizzDisplay, null),
            React.createElement("button", { onClick: this.props.minus }, "-"),
            React.createElement("button", { onClick: this.props.plus }, "+")));
    };
    return BuzzFizz;
...
function mapDispatchToFizzBuzzProps(dispatch, ownProp) {
    return {
        plus: function () { return dispatch({ type: ADD }); },
        minus: function () { return dispatch({ type: MINUS }); }
    };
}
...
var fizzBuzzFactory = react_redux_1.connect(function () { }, mapDispatchToFizzBuzzProps);
var ConnectedFizzBuzz = fizzBuzzFactory(FizzBuzz);
var fizzBuzzDisplayFactory = react_redux_1.connect(mapStateToFizzBuzzDisplayProps);
var ConnectedFizzBuzzDisplay = fizzBuzzDisplayFactory(FizzBuzzDisplay);
var ConnectedBuzzFizz = fizzBuzzFactory(BuzzFizz);
var ConnectedBuzzFizzDisplay = fizzBuzzDisplayFactory(FizzBuzzDisplay);
react_dom_1.render(React.createElement(react_redux_1.Provider, { store: store },
    React.createElement(ConnectedFizzBuzz, null)), document.getElementById("root"));
